  ...
  data.forEach((d) => {
    ...
    if (hasData) {
      col
        ...
        .attr('width', barWidth)
        .attr('y', yBottomTop)
        .attr('height', Math.max(0, yBase - yBottomTop))
      ...
      col
        ...
        .attr('x', barX(d))
        .attr('width', barWidth)
        .attr('y', yTopEdge + Math.min(4, topHeight))
        .attr('height', Math.max(0, topHeight - 4))
        .attr('fill', top.color);
    } else {
      col
        .append('rect')
